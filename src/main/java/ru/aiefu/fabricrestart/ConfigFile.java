...
public class ConfigFile {
    ...
    protected String memWatcherKillMessage = "Not enough physical memory, restarting server in 20 seconds";
    ...
    public String getMemWatcherKillMessage(){
        return Objects.requireNonNullElse(this.memWatcherKillMessage, "Not enough physical memory, restarting server in 20 seconds");
    }
